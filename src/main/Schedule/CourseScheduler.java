...
public class CourseScheduler {
    ...
    public void optimize() {
        try {
            ...
            singletonConstraint(model, assign);

            backToBackConstraint(model, assign);

            gradStudentRoomConstraint(model, assign);

            enoughSeatsConstraint(model, assign);
    ...
    private void singletonConstraint (GRBModel model, GRBVar[][][][] assign) throws GRBException {
    ...
    private void backToBackConstraint (GRBModel model, GRBVar[][][][] assign) throws GRBException {
    ...
    private void gradStudentRoomConstraint (GRBModel model, GRBVar[][][][] assign) throws GRBException {
    ...
    private void enoughSeatsConstraint (GRBModel model, GRBVar[][][][] assign) throws GRBException {
